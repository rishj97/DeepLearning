...
% load MNIST data
data = load('data4students.mat');

% validation inputs
val_x = double(data.datasetInputs{2});
% validation targets
val_y = double(data.datasetTargets{2});
...
% training inputs
train_x = double(data.datasetInputs{1});
% training targets
train_y = double(data.datasetTargets{1});

% test inputs
test_x  = double(data.datasetInputs{3});
% test targets
test_y  = double(data.datasetTargets{3});
