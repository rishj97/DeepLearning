...
def main():
    ...
    print("------------------------------")
    print_confusion_matrix(conf_matrix, True)
    print_confusion_matrix(conf_matrix, False)
...
def save_model(model):
    # Creates a HDF5 file
    model.save('facial_recognition_model' + datetime.datetime.now().strftime("%Y-%m-%d %H:%M") + '.h5')
